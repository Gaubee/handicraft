 ...
 *    1.1 过渡取首层的 seam 就此闭合）；橡皮跳过锁定/隐藏层钻归 3.x（本面语义不动）。
...
import { BrushSpecShapeError, currentLayerIdOf, getBrushRejections, getBrushSpec, onBrushStroke, setBrushRejections } from './workbench.svelte'
