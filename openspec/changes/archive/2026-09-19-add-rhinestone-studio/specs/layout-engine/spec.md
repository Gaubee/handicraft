...
1. [2026-09-18 Production] 硬约束在任何算法输出上恒真：最小间距、钻心在掩码内、带病禁导出。
2. [2026-09-18 User objective] 每块密度独立可调且钻数单调；多算法同屏供人类视觉裁决。
3. [2026-09-18 Determinism] 同输入同参数同 seed 产出逐位相同的结果（可复现生产）。
-->
